...
* Build IAM labs directly from real job descriptions
* Design identity governance processes
* Manage Joiner / Mover / Leaver lifecycles
* Enforce RBAC and least privilege
* Operate IAM through Jira-based workflows
* Document controls and limitations professionally
